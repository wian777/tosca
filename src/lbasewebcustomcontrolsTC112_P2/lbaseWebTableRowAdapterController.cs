...
namespace HtmlTable.Html.Adapter.Controller
{
    ...
    [SupportedAdapter(typeof(lbaseWebTableRowAdapter))]
    public class lbaseWebTableRowAdapterController : TableRowContextAdapterController<lbaseWebTableRowAdapter>
    {
        ...
        //      however it is not needed in this case because this Controller can deal with all lbaseWebTableRowAdapterController.
        public lbaseWebTableRowAdapterController(lbaseWebTableRowAdapter contextAdapter, ISearchQuery query, Validator validator)
            : base(contextAdapter, query, validator)
        {
        }

        #region Overrides of ContextAdapterController<lbaseWebTableRowAdapter>
