...
namespace HtmlTable.Html.Adapter
{
    ...
    public class lbaseWebTableRowAdapter : AbstractHtmlDomNodeAdapter<IHtmlDivTechnical>, ITableRowAdapter<IHtmlDivTechnical>
    {
        ...
        public lbaseWebTableRowAdapter(IHtmlDivTechnical technical, Validator validator)
            : base(technical, validator)
        {


            var res = technical.ClassName != null && (technical.Id.StartsWith("VWGROW2_") || technical.Id.StartsWith("VWGDGVFROZENCOLUMNS_"));

            validator.AssertTrue(res);
        }
