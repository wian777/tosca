...
namespace HtmlTable.Html.Adapter
{
	...
	public class lbaseWebTableColumnAdapter : AbstractHtmlDomNodeAdapter<IHtmlDivTechnical>, ITableColumnAdapter<IHtmlDivTechnical>
	{
		...
		public lbaseWebTableColumnAdapter(IHtmlDivTechnical technical, Validator validator)
			: base(technical, validator)
		{
			if (technical.ClassName != null && technical.ClassName.Contains("DataGridView-ColumnHeader"))
			{
				validator.AssertTrue(() => technical.ClassName != null && technical.ClassName.Contains("DataGridView-ColumnHeader"));
			}
			else
			{
